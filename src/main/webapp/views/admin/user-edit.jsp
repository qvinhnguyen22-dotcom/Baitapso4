...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="admin-card p-4">
            <h2 class="h4 mb-4">Sửa người dùng</h2>
            ...
            <form action="<c:url value='/admin/user/update'/>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" class="form-control" minlength="6" placeholder="Để trống nếu giữ nguyên">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="images" class="form-control" value="${user.images}">
                </div>
                <div class="mb-3">
